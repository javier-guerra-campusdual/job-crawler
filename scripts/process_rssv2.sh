...
SOURCE_URL="http://$ES_HOST/$INDEX_SOURCE/_search"
...
while true; do
  ...
  curl -X POST "localhost:9200/$INDEX_DEST/_bulk" -H "Content-Type: application/x-ndjson" --data-binary @- 
